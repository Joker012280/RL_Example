...
print("Env : {} || Task : {} || Num Epoch : {} || Device : {} || {} ".format(args.env,args.task,args.epoch,device,torch.cuda.device_count()))
...
agent = cql.CQL(state_dim,hidden,action_dim,action_bounds=action_bounds,reward_scale = args.reward_scale,device=device)    
...
torch.save({
    ...
    }, 'cql_results/'+str(args.algo)+'_'+str(args.task)+'_final_Walker2d.pth')

plot_durations("cql_results/Offline_Agent_"+str(args.algo)+'_'+str(args.task)+".png")
