...
class CQL(nn.Module):
    def __init__(self, state_dim, hidden, action_dim, action_bounds,tau=None, target_entropy=None, temperature=None,batch_size = 256,reward_scale=5,device=None):
...
#             self.critic_optimizer_2.step()
        ...
        return total_critic_loss_1, total_critic_loss_2, actor_loss
